...
model.param.set('I_S', '100[uA]', 'current applied');
model.param.set('R_L', '3.1[kohm]', 'Load Resistance');
model.param.set('d_E_fil', '0.07');
model.param.set('L_const', '2.44e-8[W/(S*K^2)]');
model.param.set('A','2');
model.param.set('alpha_fil', '-0.05');
model.param.set('atomic_vibration', '1e-13');
%model.param.set('rho_cont', '3e-9[ohm*cm^2]', 'Contact impedance coefficeint');
%model.param.set('rho_act', '0.07', 'Contact impedance activation');
...
model.component('mod1').physics('ec').feature('init1').set('V', 'I_S*R_L');
...
model.component('mod1').physics('cir').create('I1', 'CurrentSourceCircuit', -1);
model.component('mod1').physics('cir').feature('I1').set('Connections', [0; 1]);
model.component('mod1').physics('cir').feature('I1').set('value', 'I_S');
