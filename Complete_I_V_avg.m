...
for ramp_rate_loop = 1 : length(ramp_rate)
    ...
    for cycle_loop = 1 : cycle
        ...
        %Sweeps source current from minimum to maximum current values in step increament
...
save('Complete_I_V_avg_DATA.mat','I_V','DATA_OFF','DATA_min_SET','DATA_SET','DATA_ON','DATA_ON_neg','DATA_min_RESET','DATA_RESET','DATA_OFF_neg')
